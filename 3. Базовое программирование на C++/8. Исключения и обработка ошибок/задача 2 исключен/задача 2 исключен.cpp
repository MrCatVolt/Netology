...
int main()
{
    ...
    try {
        Trigl z1("треугольник: ", 3, 4, 5, 60, 60, 60);
        Figure* z3 = &z1;
        z3->get_sides_count();

        //catch (std::domain_error& e_1) {
        //    std::cout << e_1.what() << std::endl;
       // }


        regtag_Trigl z5("прямоугольный треугольник: ", 4, 5, 6, 50, 40, 90);
        Figure* z6 = &z5;
        z6->get_sides_count();
    

        isos_Trigl z7("равнобедренный треугольник: ", 3, 5, 3, 65, 50, 65);
        Figure* z8 = &z7;
        z8->get_sides_count();
 ...
 Quadr z2("квадрат: ", 4, 4, 4, 4, 90, 90, 90, 90);
    ...
    z4->get_sides_correct();
    z4->get_sides_count();


    rectangle z11("прямоугольник: ", 4, 4, 4, 4, 90, 90, 90, 90);
    Figure* z12 = &z11;
    z12->get_sides_count();

    parallelogram z13("параллелограмм: ", 4, 4, 4, 4, 90, 90, 90, 90);
    Figure* z14 = &z13;
    z14->get_sides_count();

    rhombus z15("ромб: ", 4, 4, 3, 4, 90, 90, 90, 90);
    Figure* z16 = &z15;
    z16->get_sides_count();
